...
- [emisar](https://github.com/AndrewDryga/emisar) - An MCP control plane for agents that help with infrastructure and SRE work. Agents run defined actions rather than arbitrary shell commands, with policy checks, approvals, and host-side validation.
